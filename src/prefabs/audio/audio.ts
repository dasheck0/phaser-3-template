...
export class Audio extends BaseObject {
  ...
  resumeMusic(): void {
    if (this.musicChannel && (this.musicChannel as Phaser.Sound.WebAudioSound).isPaused) {
  ...
  setMusicVolume(volume: number): void {
    ...
    if (this.musicChannel) {
      (this.musicChannel as Phaser.Sound.WebAudioSound).setVolume(this.musicVolume);
    }
  }
